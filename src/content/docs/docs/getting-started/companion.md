...
- [Install Wren 0.1.9](/docs/getting-started/install/), or a later desktop release that retains protocol 3, and keep the desktop application running.
