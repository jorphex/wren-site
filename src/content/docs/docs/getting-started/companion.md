...
- [Install Wren 0.1.8](/docs/getting-started/install/), or a later desktop release that retains protocol 3, and keep the desktop application running.
...
To remove Companion's access from Wren, open **Control center** → **Settings** → **Connections**, find the paired browser under **Browser companions**, and select **Revoke**.
